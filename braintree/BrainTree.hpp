...
namespace BrainTree
{
    ...
    class Node
    {
      public:
        ...
        virtual void terminate([[maybe_unused]] Status s)
        {
        }
    ...
    template <class Parent> class CompositeBuilder
    {
      public:
        ...
        template <class NodeType, typename... Args> CompositeBuilder<Parent> leaf(Args... args)
        {
    ...
    template <class Parent> class DecoratorBuilder
    {
      public:
        ...
        template <class NodeType, typename... Args> DecoratorBuilder<Parent> leaf(Args... args)
        {
            auto child = std::make_shared<NodeType>((args)...);
            child->setBlackboard(node->getBlackboard());
            node->setChild(child);
    ...
    class Builder
    {
      public:
        ...
        template <class NodeType, typename... Args> Builder leaf(Args... args)
        {
        ...
        template <class CompositeType, typename... Args> CompositeBuilder<Builder> composite(Args... args)
        {
        ...
        template <class DecoratorType, typename... Args> DecoratorBuilder<Builder> decorator(Args... args)
        {
